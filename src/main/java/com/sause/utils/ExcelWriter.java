...
public class ExcelWriter {
    ...
    public ExcelWriter getSheetByName(String sheetName) throws IOException {
        fis = new FileInputStream("./Excel/BA_Portal_Excel.xlsx");
        workbook = new XSSFWorkbook(fis);
        sheet = workbook.getSheet(sheetName);
        return this;
    }

    public ExcelWriter getSheetByIndex(int sheetNumber) throws IOException {
        fis = new FileInputStream("./Excel/BA_Portal_Excel.xlsx");
        workbook = new XSSFWorkbook(fis);
    ...
    public ExcelWriter getRequiredRow(int rowNumber) {
    ...
    public ExcelWriter getRequiredColumn(int columnNumber, String excelInpuString) throws IOException {
        int currentColumn = columnNumber - 1;
        System.out.println(currentColumn);
        cell = row.getCell(currentColumn);
        // System.out.println(excelInpuString);
        cell = row.getCell(currentColumn, Row.MissingCellPolicy.CREATE_NULL_AS_BLANK);
        cell.setCellValue(excelInpuString);
        System.out.println(excelInpuString);
        // if (excelInpuString instanceof String) {
        // cell.setCellValue(excelInpuString);
        // System.out.println(excelInpuString);
        // return this;
        ...
        // return this;
        // }
        fos = new FileOutputStream("./Excel/BA_Portal_Excel.xlsx");
        workbook.write(fos);
        fos.close();
        return this;
    }

    public ExcelWriter getByRowHeading(String rowHeader) {
    ...
    public ExcelWriter getByColumnHeading(String columnHeading, String setvalue) throws IOException {
        int totalRow = sheet.getLastRowNum();
        for (int currentRow = 0; currentRow <= totalRow; currentRow++) {
            row = sheet.getRow(currentRow);
            if (row != null) {
